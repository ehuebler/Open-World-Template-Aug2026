...
Run headless from the project root:
    ...
    & "C:\\Program Files\\Blender Foundation\\Blender 5.1\\blender.exe" --background assets/source/blender/bottles.blend --python assets/source/blender/render_bottles.py
