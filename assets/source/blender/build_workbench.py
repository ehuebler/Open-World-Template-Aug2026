"""Builds the workbench prop and exports it to assets/runtime/items/workbench.glb.

Run headless from the project root; it does not need an input .blend:

    & "C:\\Program Files\\Blender Foundation\\Blender 5.1\\blender.exe" --background --factory-startup --python assets/source/blender/build_workbench.py
