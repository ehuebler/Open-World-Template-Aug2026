"""Builds the two hand-held bottles and exports assets/runtime/items/water_bottle.glb
and assets/runtime/items/chemical_flask.glb.

Run headless from the project root; it needs no input .blend:

    & "C:\\Program Files\\Blender Foundation\\Blender 5.1\\blender.exe" --background --factory-startup --python assets/source/blender/build_bottles.py
...
assets/runtime/characters/player_character.glb - character_ref.py reports the fist's radius
