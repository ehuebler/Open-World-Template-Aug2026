"""Repaint `assets/source/meshmaker/cityhall.blend` from its own geometry.

    blender --background assets/source/meshmaker/cityhall.blend --python assets/source/blender/paint_cityhall.py
...
BLEND = os.path.join(
    ROOT, "assets", "source", "meshmaker", "cityhall.blend")
