...
Run headless from the project root:
    ...
    & "C:\\Program Files\\Blender Foundation\\Blender 5.1\\blender.exe" --background assets/source/meshmaker/cityhall.blend --python assets/source/blender/render_cityhall.py

Images land in assets/previews/authoring/. Every framing is shot twice: lit,
