...
and how close each clip brings an arm to the body.
    ...
    & "C:\\Program Files\\Blender Foundation\\Blender 5.1\\blender.exe" --background --factory-startup assets/source/blender/player_character.blend --python assets/source/blender/_arm_check.py
