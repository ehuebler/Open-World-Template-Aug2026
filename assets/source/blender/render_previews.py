...
.blend:
    ...
    & "C:\\Program Files\\Blender Foundation\\Blender 5.1\\blender.exe" --background assets/source/blender/player_character.blend --python assets/source/blender/render_previews.py

Images land in assets/previews/authoring/. `body_*` shows the bare body,
