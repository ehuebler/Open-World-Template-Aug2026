...
def main() -> None:
    print("\n=== flower tree v2 ===")
    for directory in (MODEL_DIR, PAINT_DIR, PREVIEW_DIR, MANIFEST_DIR):
    ...
    glb_path = os.path.join(MODEL_DIR, "flower_tree.glb")
    ...
    metadata = {
        "source": "assets/source/blender/flower_tree_asset.py",
        "generator_version": 2,
        ...
        "color_paint": "assets/runtime/biomes/paint/flower_tree_paint.png",
        ...
        "runtime_contract": {
            ...
            "mesh_count": 2,
            "primitive_count": 2,
            "paint_texture": "assets/runtime/biomes/paint/flower_tree_paint.png",
            "emission_mask": (
                "assets/runtime/biomes/paint/flower_tree_paint.png alpha"),
            "skins": 0,
            "animations": 0,
            "ground_axis": "Godot/glTF +Y",
        },
    }
    json_path = os.path.join(MANIFEST_DIR, "flower_tree.json")
