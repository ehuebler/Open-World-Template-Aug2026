...
SPECIES = (
    {
        ...
        "toughness": 0,  # SOFT
        "population_limit": 18,
        "mate_search_range": 70.0,
        "mate_distance": 0.85,
        "mate_cooldown": 55.0,
        "courtship_seconds": 1.4,
        "newborn_scale": 0.45,
        "growth_seconds": 75.0,
        "walk_speed": 1.65,
        "run_speed": 4.7,
    ...
    },
    {
        ...
        "toughness": 1,  # WOODY
        "population_limit": 10,
        "mate_search_range": 90.0,
        "mate_distance": 2.0,
        "mate_cooldown": 75.0,
        "courtship_seconds": 1.8,
        "newborn_scale": 0.38,
        "growth_seconds": 110.0,
        "walk_speed": 2.2,
        "run_speed": 7.2,
    ...
    },
    {
        ...
        "steady_over": 2.6,
        "steady_within": 1.1,
        # Frontier animals only. They are placed on the settlement's boundary
        # rather than streamed across the planet, so that meeting one is a
        # consequence of leaving town rather than of walking anywhere at all.
        "global_population": False,
        "cell_size": 96.0,
        "spawn_chance": 0.12,
        "pack_min": 1,
        ...
        "colony_count": 5,
        "settlement_edge": True,
        "edge_margin_near": 8.0,
        "edge_margin_far": 30.0,
        "health": 190.0,
        "health_per_metre": 30.0,
        "toughness": 1,  # WOODY
        # Their frontier sectors are far apart; adults will cross the ring when
        # they choose one another instead of being unable to replenish at all.
        "population_limit": 8,
        "mate_search_range": 180.0,
        "mate_distance": 2.15,
        "mate_cooldown": 100.0,
        "courtship_seconds": 2.0,
        "newborn_scale": 0.40,
        "growth_seconds": 140.0,
        "walk_speed": 1.9,
        "run_speed": 6.4,
        # Heavy: it takes a moment to get going and it turns like a truck, which
        # is what makes standing still the wrong answer and stepping the right.
        "move_acceleration": 14.0,
        "turn_speed": 3.2,
        "wander_radius": 16.0,
        "wander_pause": 3.2,
        # It has to see far enough to have room to charge, so notice reaches
        # past the band it charges from.
        "notice_range": 27.0,
        "flee_range": 0.0,
        "physics_within": 55.0,
        "skeletal_clips": True,
        ...
        "clip_blend": 0.14,
        "attack_damage": 34.0,
        # Reach and width are the horn's, swept from the chest through the tip.
        "attack_range": 2.6,
        "attack_radius": 1.15,
        # The windup is the pawing. Long on purpose: it is the only warning.
        "attack_windup": 0.95,
        "attack_cooldown": 3.2,
