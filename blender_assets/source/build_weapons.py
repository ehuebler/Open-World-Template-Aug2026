"""Builds the dual-wieldable weapons and exports blender_assets/sword.glb and
blender_assets/laser_rifle.glb.

Run headless from the project root; it needs no input .blend:

    & "C:\\Program Files\\Blender Foundation\\Blender 5.1\\blender.exe" --background --factory-startup --python blender_assets/source/build_weapons.py
...
Grips are **measured off blender_assets/player_character.glb** rather than
