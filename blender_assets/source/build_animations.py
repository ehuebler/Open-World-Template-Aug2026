...
Run headless from the project root, with the Blender version that saved the file:
    ...
    & "C:\\Program Files\\Blender Foundation\\Blender 5.1\\blender.exe" --background --factory-startup blender_assets/source/player_character.blend --python blender_assets/source/build_animations.py
