...
file (opening a newer .blend in an older Blender silently drops data):
    ...
    & "C:\\Program Files\\Blender Foundation\\Blender 5.1\\blender.exe" --background blender_assets/source/player_character.blend --python blender_assets/source/export_glb.py
