...
.blend (opening a newer file in an older Blender drops data):
    ...
    & "C:\\Program Files\\Blender Foundation\\Blender 5.1\\blender.exe" --background blender_assets/source/player_character.blend --python blender_assets/source/build_apparel.py
