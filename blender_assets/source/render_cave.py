...
Run headless from the project root:
    ...
    & "C:\\Program Files\\Blender Foundation\\Blender 5.1\\blender.exe" --background blender_assets/source/cave_room.blend --python blender_assets/source/render_cave.py

Images land in blender_assets/source/previews/. Unlike the prop previews this
