...
Run headless from the project root:
    ...
    & "C:\\Program Files\\Blender Foundation\\Blender 5.1\\blender.exe" --background blender_assets/source/workbench.blend --python blender_assets/source/render_workbench.py

Images land in blender_assets/source/previews/. `workbench_open` winds the vice out
