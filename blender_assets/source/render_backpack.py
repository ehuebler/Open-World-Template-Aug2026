...
Run headless from the project root:
    ...
    & "C:\\Program Files\\Blender Foundation\\Blender 5.1\\blender.exe" --background blender_assets/source/backpack.blend --python blender_assets/source/render_backpack.py

Images land in blender_assets/source/previews/. The pack is authored in the
