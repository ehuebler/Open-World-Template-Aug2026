"""Turns the ground material photographs in `generated/textures/` into the two
...
the source images:
    ...
    & $blender --background --factory-startup --python blender_assets/source/build_ground_textures.py
...
IN_DIR = os.path.join(PROJECT_DIR, "generated", "textures")
