...
system Python or Blender's bundled Python:
    ...
    python blender_assets/source/build_biome_catalog.py
...
MODEL_ROOT = "res://blender_assets"
PAINT_ROOT = "res://blender_assets/biome_paint"
...
def build_species(check_assets: bool) -> None:
    for entry in SPECIES:
        ...
        model_disk = PROJECT_DIR / "blender_assets" / f"{model_name}.glb"
        paint_disk = (
            PROJECT_DIR / "blender_assets" / "biome_paint"
