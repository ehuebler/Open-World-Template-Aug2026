"""Builds the cave entry room and exports blender_assets/cave_room.glb.

Run headless from the project root; it needs no input .blend:

    & "C:\\Program Files\\Blender Foundation\\Blender 5.1\\blender.exe" --background --factory-startup --python blender_assets/source/build_cave.py
